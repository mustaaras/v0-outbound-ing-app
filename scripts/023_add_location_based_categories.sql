...
INSERT INTO strategies (name, description, tier, category, input_fields, prompt) VALUES
  (
    ...
    'free',
    'Local Services',
    ARRAY['recipient', 'service_area', 'service_type'],
  ...
  (
    ...
    'free',
    'Local Services',
    ARRAY['recipient', 'emergency_service', 'location'],
  ...
  (
    ...
    'light',
    'Local Services',
    ARRAY['recipient', 'seasonal_service', 'season'],
  ...
  (
    ...
    'light',
    'Local Services',
    ARRAY['recipient', 'complementary_service', 'mutual_benefits'],
  ...
  (
    ...
    'pro',
    'Local Services',
    ARRAY['recipient', 'service_type', 'local_competition'],
  ...
  (
    ...
    'pro',
    'Local Services',
    ARRAY['recipient', 'service_guarantee', 'industry_standard'],
  ...
  (
    ...
    'pro',
    'Local Services',
    ARRAY['recipient', 'equipment_type', 'efficiency_gains'],
...
INSERT INTO strategies (name, description, tier, category, input_fields, prompt) VALUES
  (
    ...
    'free',
    'Hospitality & Food Service',
    ARRAY['recipient', 'event_type', 'catering_capacity'],
  ...
  (
    ...
    'free',
    'Hospitality & Food Service',
    ARRAY['recipient', 'delivery_radius', 'delivery_platform'],
  ...
  (
    ...
    'light',
    'Hospitality & Food Service',
    ARRAY['recipient', 'seasonal_theme', 'menu_innovation'],
  ...
  (
    ...
    'light',
    'Hospitality & Food Service',
    ARRAY['recipient', 'group_size', 'corporate_benefits'],
  ...
  (
    ...
    'pro',
    'Hospitality & Food Service',
    ARRAY['recipient', 'local_ingredient', 'farm_to_table_benefits'],
  ...
  (
    ...
    'pro',
    'Hospitality & Food Service',
    ARRAY['recipient', 'loyalty_features', 'retention_rate_improvement'],
  ...
  (
    ...
    'pro',
    'Hospitality & Food Service',
    ARRAY['recipient', 'venue_capacity', 'event_types'],
...
INSERT INTO strategies (name, description, tier, category, input_fields, prompt) VALUES
  (
    ...
    'free',
    'Healthcare & Wellness',
    ARRAY['recipient', 'specialty_area', 'patient_demographic'],
  ...
  (
    ...
    'free',
    'Healthcare & Wellness',
    ARRAY['recipient', 'telemedicine_benefits', 'patient_convenience'],
  ...
  (
    ...
    'light',
    'Healthcare & Wellness',
    ARRAY['recipient', 'wellness_focus', 'community_impact'],
  ...
  (
    ...
    'light',
    'Healthcare & Wellness',
    ARRAY['recipient', 'education_topic', 'patient_engagement_benefits'],
  ...
  (
    ...
    'pro',
    'Healthcare & Wellness',
    ARRAY['recipient', 'new_specialty', 'market_demand'],
  ...
  (
    ...
    'pro',
    'Healthcare & Wellness',
    ARRAY['recipient', 'healthcare_technology', 'efficiency_improvements'],
  ...
  (
    ...
    'pro',
    'Healthcare & Wellness',
    ARRAY['recipient', 'community_partner', 'health_outcomes'],
...
INSERT INTO strategies (name, description, tier, category, input_fields, prompt) VALUES
  (
    ...
    'free',
    'Retail & Shopping',
    ARRAY['recipient', 'event_type', 'brand_exposure_benefits'],
  ...
  (
    ...
    'free',
    'Retail & Shopping',
    ARRAY['recipient', 'loyalty_upgrade', 'customer_retention_improvement'],
  ...
  (
    ...
    'light',
    'Retail & Shopping',
    ARRAY['recipient', 'pop_up_concept', 'traffic_increase'],
  ...
  (
    ...
    'light',
    'Retail & Shopping',
    ARRAY['recipient', 'community_program', 'brand_loyalty_benefits'],
  ...
  (
    ...
    'pro',
    'Retail & Shopping',
    ARRAY['recipient', 'ecommerce_platform', 'omnichannel_benefits'],
  ...
  (
    ...
    'pro',
    'Retail & Shopping',
    ARRAY['recipient', 'personalization_tech', 'conversion_rate_improvement'],
  ...
  (
    ...
    'pro',
    'Retail & Shopping',
    ARRAY['recipient', 'sustainability_focus', 'customer_appeal'],
...
INSERT INTO strategies (name, description, tier, category, input_fields, prompt) VALUES
  (
    ...
    'free',
    'Fitness & Personal Care',
    ARRAY['recipient', 'membership_offer', 'target_demographic'],
  ...
  (
    ...
    'free',
    'Fitness & Personal Care',
    ARRAY['recipient', 'wellness_partner', 'cross_promotion_benefits'],
  ...
  (
    ...
    'light',
    'Fitness & Personal Care',
    ARRAY['recipient', 'class_type', 'community_engagement'],
  ...
  (
    ...
    'light',
    'Fitness & Personal Care',
    ARRAY['recipient', 'training_specialty', 'client_acquisition_benefits'],
  ...
  (
    ...
    'pro',
    'Fitness & Personal Care',
    ARRAY['recipient', 'digital_platform', 'engagement_improvements'],
  ...
  (
    ...
    'pro',
    'Fitness & Personal Care',
    ARRAY['recipient', 'corporate_program', 'business_development_opportunities'],
  ...
  (
    ...
    'pro',
    'Fitness & Personal Care',
    ARRAY['recipient', 'recovery_service', 'performance_enhancement'],
