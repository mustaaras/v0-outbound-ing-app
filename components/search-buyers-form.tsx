...
export function SearchContactsForm({ userId, userTier, searchesUsed, searchLimit }: SearchContactsFormProps) {
  // Beta feature: Only available for Pro users
  ...
  if (searchLimit === 0) {
    ...
    return (
      <div className="space-y-6">
        <Card className="border-blue-400/30 bg-blue-100/10">
          <CardContent className="p-4 flex items-start gap-3">
            <AlertCircle className="h-5 w-5 text-blue-800 flex-shrink-0 mt-0.5" />
            <div className="space-y-1">
              <p className="text-sm font-semibold text-blue-800">Pro Feature</p>
              <p className="text-sm text-blue-800">
                Search Contacts is available for Pro users only. Upgrade to Pro to access verified contact search with 150 searches per month.
              </p>
            </div>
          </CardContent>
        </Card>
